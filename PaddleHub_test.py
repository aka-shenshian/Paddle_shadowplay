...
pose_estimation.keypoint_detection(paths=[''], visualization=True, output_dir="work/output_pose/")

image
saved in work / output_pose / body01.jpg
...
def get_combine_img(img_path, pose_estimation, body_img_path_map, backgroup_img_path='work/background.jpg'):
    ...
    # 右大腿
    append_img_reset_width = max(int(
        get_distences(result[0]['data']['pelvis'][0], result[0]['data']['pelvis'][1], result[0]['data']['left_hip'][0],
...
# 素材图片的位置信息
body_img_path_map = {
    "right_hip": "./work/img_change/jpg/right_hip.jpg",
    "right_knee": "./work/img_change/jpg/right_knee.jpg",
    "left_hip": "./work/img_change/jpg/left_hip.jpg",
    "left_knee": "./work/img_change/jpg/left_knee.jpg",
    "left_elbow": "./work/img_change/jpg/left_elbow.jpg",
    "left_wrist": "./work/img_change/jpg/left_wrist.jpg",
    "right_elbow": "./work/img_change/jpg/right_elbow.jpg",
    "right_wrist": "./work/img_change/jpg/right_wrist.jpg",
    "head": "./work/img_change/jpg/head.jpg",
    "body": "./work/img_change/jpg/body.jpg"
}
